...
class SubjectDetailsRetrieverServiceTest {

	@Mock
	private SubjectRepository repository;
	@Mock
	private Mono<Subject> mockMono;

	@InjectMocks
	private SubjectDetailsRetrieverService service = new SubjectDetailsRetrieverService(repository);
