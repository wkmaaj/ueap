...
class PersonValidationServiceTest {
	...
	@Mock
	private EntityNodeUidGenerationService<Person> generator;

	@InjectMocks
	private EntityValidationService<Person> service = new PersonValidationService(repository, generator, log);
