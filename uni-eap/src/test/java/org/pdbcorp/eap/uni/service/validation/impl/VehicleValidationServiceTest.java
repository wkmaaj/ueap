...
class VehicleValidationServiceTest {
	...
	@Mock
	private EntityNodeUidGenerationService<Vehicle> generator;

	@InjectMocks
	private EntityValidationService<Vehicle> service = new VehicleValidationService(repository, generator, log);
