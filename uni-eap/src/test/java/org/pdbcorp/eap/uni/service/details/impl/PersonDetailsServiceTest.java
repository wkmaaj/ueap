...
class PersonDetailsServiceTest {
	...
	@Mock
	private EntityValidationService<Person> validator;
	@Mock
	private EntityPersistenceService<Person> persistence;

	@InjectMocks
	private PersonDetailsService service = new PersonDetailsService(repository, validator, persistence);
