...
class StudentDetailsServiceTest {
	...
	@Mock
	private EntityValidationService<Student> validator;
	@Mock
	private EntityPersistenceService<Student> persistence;

	@InjectMocks
	private StudentDetailsService service = new StudentDetailsService(repository, validator, persistence);
