...
class AddTeacherProcessFlowTest {

	@Mock
	private RetrieveEntityDetailsService<Teacher> retrieveEntityDetailsService;
	@Mock
	private GenerateNodeUidService<Teacher> generateNodeUidService;
	@Mock
	private ValidateEntityRelationshipsService<Teacher> validateEntityRelationshipsService;
	@Mock
	private ValidateNodeUidService<Teacher> validateNodeUidService;

	@InjectMocks
	private AddEntityProcessFlow<Teacher> addEntityProcessFlow = new AddTeacherProcessFlow(
	...
	void validExecuteTest() throws Exception {
		Teacher entity = TestDataFactoryUtil.generateTeacherInstance();
