...
class TeacherDetailsServiceTest {

	@Mock
	private TeacherRepository repository;
	@Mock
	private EntityValidationService<Teacher> validator;
	@Mock
	private EntityPersistenceService<Teacher> persistence;

	@InjectMocks
	private TeacherDetailsService service = new TeacherDetailsService(repository, validator, persistence);
