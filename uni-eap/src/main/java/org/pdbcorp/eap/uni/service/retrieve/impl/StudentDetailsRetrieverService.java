...
@Slf4j
@Service
public class StudentDetailsRetrieverService extends RetrieveBaseEntityDetailsService<Student> {

	private StudentRepository studentRepository;

	@Autowired
	StudentDetailsRetrieverService(StudentRepository studentRepository) {
