...
@Slf4j
@Service
class AddPersonProcessFlow extends AddEntityProcessFlow<Person> {

	@Autowired
	AddPersonProcessFlow(
			RetrieveEntityDetailsService<Person> retrieveEntityDetailsService,
			GenerateNodeUidService<Person> generateNodeUidService,
			ValidateEntityRelationshipsService<Person> validateEntityRelationshipsService,
			ValidateNodeUidService<Person> validateNodeUidService) {
