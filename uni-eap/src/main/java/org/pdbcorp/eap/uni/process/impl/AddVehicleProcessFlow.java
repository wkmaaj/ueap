...
@Slf4j
@Service
class AddVehicleProcessFlow extends AddEntityProcessFlow<Vehicle> {

	@Autowired
	AddVehicleProcessFlow(
			RetrieveEntityDetailsService<Vehicle> retrieveEntityDetailsService,
			GenerateNodeUidService<Vehicle> generateNodeUidService,
			ValidateEntityRelationshipsService<Vehicle> validateEntityRelationshipsService,
			ValidateNodeUidService<Vehicle> validateNodeUidService) {
