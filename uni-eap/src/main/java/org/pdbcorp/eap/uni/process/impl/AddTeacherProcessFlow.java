...
@Slf4j
@Service
class AddTeacherProcessFlow extends AddEntityProcessFlow<Teacher> {

	@Autowired
	AddTeacherProcessFlow(
			RetrieveEntityDetailsService<Teacher> retrieveEntityDetailsService,
			GenerateNodeUidService<Teacher> generateNodeUidService,
			ValidateEntityRelationshipsService<Teacher> validateEntityRelationshipsService,
			ValidateNodeUidService<Teacher> validateNodeUidService) {
