...
@Slf4j
@Service
public class SubjectDetailsRetrieverService extends RetrieveBaseEntityDetailsService<Subject> {

	private SubjectRepository subjectRepository;

	@Autowired
	SubjectDetailsRetrieverService(SubjectRepository subjectRepository) {
		super(subjectRepository, log);
