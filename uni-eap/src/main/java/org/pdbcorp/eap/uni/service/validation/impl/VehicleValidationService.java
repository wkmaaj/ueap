...
@Slf4j
@Service
class VehicleValidationService extends BaseEntityValidationService<Vehicle> {

	@Autowired
	VehicleValidationService(
			@Qualifier("vehicleRepository") BaseEntityRepository<Vehicle> vehicleRepository,
			@Qualifier("vehicleNodeUidGenerationService") EntityNodeUidGenerationService<Vehicle> vehicleNodeUidGenerationService) {
		
		this(vehicleRepository, vehicleNodeUidGenerationService, log);
	}

	VehicleValidationService(
			BaseEntityRepository<Vehicle> entityRepository,
			EntityNodeUidGenerationService<Vehicle> entityNodeUidGenerationService,
			Logger log) {
