...
@Slf4j
@Service
class AddUniversityProcessFlow extends AddEntityProcessFlow<University> {

	@Autowired
	AddUniversityProcessFlow(
			RetrieveEntityDetailsService<University> retrieveEntityDetailsService,
			GenerateNodeUidService<University> generateNodeUidService,
			ValidateEntityRelationshipsService<University> validateEntityRelationshipsService,
			ValidateNodeUidService<University> validateNodeUidService) {
