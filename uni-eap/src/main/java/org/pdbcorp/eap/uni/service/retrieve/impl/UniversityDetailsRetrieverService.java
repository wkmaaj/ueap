...
@Slf4j
@Service
public class UniversityDetailsRetrieverService extends RetrieveBaseEntityDetailsService<University> {

	private UniversityRepository universityRepository;

	@Autowired
	UniversityDetailsRetrieverService(UniversityRepository universityRepository) {
