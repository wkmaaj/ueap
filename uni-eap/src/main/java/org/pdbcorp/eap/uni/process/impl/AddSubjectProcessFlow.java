...
@Slf4j
@Service
class AddSubjectProcessFlow extends AddEntityProcessFlow<Subject> {

	@Autowired
	AddSubjectProcessFlow(
			RetrieveEntityDetailsService<Subject> retrieveEntityDetailsService,
			GenerateNodeUidService<Subject> generateNodeUidService,
			ValidateEntityRelationshipsService<Subject> validateEntityRelationshipsService,
			ValidateNodeUidService<Subject> validateNodeUidService) {
