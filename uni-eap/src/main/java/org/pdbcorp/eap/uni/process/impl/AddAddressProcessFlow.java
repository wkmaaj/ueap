...
@Slf4j
@Service
class AddAddressProcessFlow extends AddEntityProcessFlow<Address> {

	@Autowired
	AddAddressProcessFlow(
			RetrieveEntityDetailsService<Address> retrieveEntityDetailsService,
			GenerateNodeUidService<Address> generateNodeUidService,
			ValidateEntityRelationshipsService<Address> validateEntityRelationshipsService,
			ValidateNodeUidService<Address> validateNodeUidService) {
