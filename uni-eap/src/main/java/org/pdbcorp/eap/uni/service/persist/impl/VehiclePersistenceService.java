...
@Slf4j
@Service
public class VehiclePersistenceService implements EntityPersistenceService<Vehicle> {
	...
	public Vehicle validateEntityRelationships(Vehicle vehicle) {
		if(vehicle.getPerson() != null) {
			...
			vehicle.setPerson(personDetailsService.validateAndSave(vehicle.getPerson()));
