...
@Slf4j
@Service
public class CourseDetailsRetrieverService extends RetrieveBaseEntityDetailsService<Course> {

	private CourseRepository courseRepository;

	@Autowired
	CourseDetailsRetrieverService(CourseRepository courseRepository) {
