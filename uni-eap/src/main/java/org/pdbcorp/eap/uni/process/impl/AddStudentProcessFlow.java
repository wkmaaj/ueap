...
@Slf4j
@Service
class AddStudentProcessFlow extends AddEntityProcessFlow<Student> {

	@Autowired
	AddStudentProcessFlow(
			RetrieveEntityDetailsService<Student> retrieveEntityDetailsService,
			GenerateNodeUidService<Student> generateNodeUidService,
			ValidateEntityRelationshipsService<Student> validateEntityRelationshipsService,
			ValidateNodeUidService<Student> validateNodeUidService) {
