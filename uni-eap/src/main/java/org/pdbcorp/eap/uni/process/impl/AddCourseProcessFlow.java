...
@Slf4j
@Service
class AddCourseProcessFlow extends AddEntityProcessFlow<Course> {

	@Autowired
	AddCourseProcessFlow(
			RetrieveEntityDetailsService<Course> retrieveEntityDetailsService,
			GenerateNodeUidService<Course> generateNodeUidService,
			ValidateEntityRelationshipsService<Course> validateEntityRelationshipsService,
			ValidateNodeUidService<Course> validateNodeUidService) {
